...
@section('title', 'Laporan Hasil Seleksi Kader')

@section('content')
<style>
/* Laporan Kader Styles - LAZISMU DIY */
/* Laporan Kader Styles - LAZISMU DIY Orange Theme */
:root {
    ...
    --info-color: #17a2b8;         /* Biru info (untuk referensi saja) */
...
@media print {
    ...
    body::before {
        content: "LAZISMU DIY - Laporan Hasil Seleksi Beasiswa Kader";
        display: block;
        text-align: center;
        font-size: 18px;
        font-weight: bold;
...
<div class="laporan-container">
    <div class="page-header no-print">
        <h1 class="page-title">
            ...
            Laporan Hasil Seleksi Beasiswa Kader
        </h1>
        <p class="page-subtitle">
            Laporan lengkap hasil seleksi dan penilaian calon penerima beasiswa kader
        </p>
    </div>
    ...
    <div class="filter-card no-print">
        ...
        <form action="{{ route('admin.laporan.kader') }}" method="GET" id="filterForm">
            ...
            <div class="filter-actions">
                ...
                <a href="{{ route('admin.laporan.kader') }}" class="btn btn-secondary">
        ...
        <div class="table-responsive">
            ...
            @else
                <div class="empty-state">
                    ...
                    <p>Data hasil seleksi beasiswa kader belum tersedia</p>
                </div>
            @endif
        </div>
    </div>
...
function exportExcel() {
    ...
    // Header
    csvContent += "No,Nama Lengkap,Email,NIM/NPM,Universitas,Jurusan,Pengalaman Organisasi,Nilai SAW,Ranking,Status Beasiswa\n";
    ...
    hasilSeleksi.forEach((data, index) => {
        ...
        csvContent += `"${no}","${nama}","${email}","${nim}","${universitas}","${jurusan}","${pengalaman}","${nilai}","${ranking}","${status}"\n`;
    });
    ...
    link.setAttribute("download", `Laporan_Seleksi_Kader_${getDateString()}.csv`);
...
window.addEventListener('beforeprint', () => {
    document.title = 'Laporan Hasil Seleksi Beasiswa Kader - LAZISMU DIY';
});

window.addEventListener('afterprint', () => {
    document.title = 'Laporan Hasil Seleksi Kader';
});
...
console.log('📊 Laporan Kader page loaded successfully!');
