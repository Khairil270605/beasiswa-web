...
@section('title', 'Data Kriteria Dhuafa')
...
<div class="kriteria-container">
        ...
        <div class="row align-items-center">
            <div class="col-md-8">
                <h1 class="page-title">
                    ...
                    Data Kriteria Dhuafa
                </h1>
                <p class="page-subtitle">
                    Kelola kriteria penilaian untuk calon penerima <strong>Beasiswa Dhuafa</strong>
                </p>
            </div>
            <div class="col-md-4 text-md-right">
                <div class="d-flex justify-content-md-end">
                    <div class="stat-item">
                        ...
                        <div class="stat-label">Total Kriteria Dhuafa</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="alert-info">
        ...
        Kriteria Dhuafa digunakan untuk menilai kondisi ekonomi dan sosial calon penerima beasiswa.
        Pastikan total bobot seluruh kriteria = 1 (100%).
    </div>
    ...
    <div class="action-section">
        <div class="row align-items-center">
            <div class="col-md-6">
                <a href="{{ route('admin.kriteria.dhuafa.create') }}" class="btn-add">
                    <i class="fas fa-plus"></i>
                    Tambah Kriteria Dhuafa
                </a>
            </div>
            <div class="col-md-6 text-md-right mt-3 mt-md-0">
                <small class="text-muted">
                    <i class="fas fa-lightbulb mr-1" style="color: var(--secondary-color);"></i>
                    Fokuskan kriteria pada aspek ekonomi, tanggungan, dan kondisi sosial
                </small>
            </div>
        </div>
    </div>
