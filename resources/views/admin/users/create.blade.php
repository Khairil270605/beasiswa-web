...
<div class="user-create-container">
    ...
    <div class="page-header">
        ...
        <p class="page-subtitle">Buat akun pengguna baru untuk sistem Lazismu</p>
    </div>

    <!-- Form Card -->
    <div class="card-form">
        <div class="card-header-form">
            <h5>Form Data User</h5>
        </div>
            ...
            <form action="{{ route('admin.users.store') }}" method="POST" id="userForm">
                ...
                <div class="form-group">
                    ...
                    <div class="role-options">
                        ...
                        <div class="role-option {{ old('role') == 'pewawancara' ? 'selected' : '' }}" onclick="selectRole('pewawancara')">
                            <input type="radio" 
                                   name="role" 
                                   value="pewawancara" 
                                   id="role-pewawancara"
                                   {{ old('role') == 'pewawancara' ? 'checked' : '' }}
                                   required>
                            <div class="role-info">
                                <h6>Pewawancara</h6>
