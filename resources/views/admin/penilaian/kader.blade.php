...
@section('title', 'Data Penilaian Kader')

@section('content')
<style>
/* Data Penilaian Kader Page Styles - LAZISMU DIY Consistent Style */
:root {
        ...
        <div class="row align-items-center">
            <div class="col-md-8">
                <h1 class="page-title">
                    ...
                    Penilaian Beasiswa Kader
                </h1>
                <p class="page-subtitle">
                    Kelola penilaian kriteria peserta kategori Kader
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="table-container fade-in">
        <div class="table-header">
            <h3 class="table-title">
                ...
                Daftar Penilaian Peserta Kader
            </h3>
        </div>
                        ...
                        <td colspan="5">
                            <div class="empty-state">
                                ...
                                <div class="empty-text">
                                    Belum ada data penilaian untuk kategori Kader.<br>
...
function exportData() {
    ...
    link.setAttribute("download", `data_penilaian_kader_${new Date().toISOString().slice(0,10)}.csv`);
...
function printTable() {
    ...
    printWindow.document.write(`
        <html>
        <head>
            <title>Data Penilaian Kader</title>
            <style>
                body { 
        ...
        <body>
            <h2>Data Penilaian Beasiswa Kader</h2>
...
console.log('📊 Data Penilaian Kader page loaded successfully!');
