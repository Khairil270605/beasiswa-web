...
@section('title', 'Data Sub Kriteria Dhuafa')
        ...
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h1 class="page-title">
                    ...
                    Data Sub Kriteria Dhuafa
                </h1>
                <p class="page-subtitle">Kelola sub kriteria penilaian untuk calon penerima <strong>Beasiswa Dhuafa</strong></p>
            </div>
        </div>
    </div>
    ...
    <div class="action-section">
        <div class="d-flex justify-content-between align-items-center">
            <div class="alert-info flex-grow-1 me-3 mb-0">
                ...
                <strong>Panduan:</strong> Sub kriteria adalah detail penilaian dari setiap kriteria utama kategori Dhuafa.
            </div>
            <a href="{{ route('admin.subkriteria.dhuafa.create') }}" class="btn-add">
                <i class="fas fa-plus"></i>
                Tambah Sub Kriteria Dhuafa
            </a>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="stat-item">
                    ...
                    <div class="stat-label">Total Sub Kriteria Dhuafa</div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="stat-item">
                        ...
                        <tr>
                            <td colspan="5">
                                <div class="empty-state">
                                    ...
                                    <h3 class="empty-title">Belum Ada Data Sub Kriteria Dhuafa</h3>
                                    <p class="empty-text">
                                        Silakan tambahkan sub kriteria untuk kategori Dhuafa terlebih dahulu.
                                        @if($kriterias->count() == 0)
                                        <br><small class="text-danger"><i class="fas fa-exclamation-triangle"></i> Pastikan sudah membuat Kriteria Dhuafa terlebih dahulu</small>
                                        @endif
                                    </p>
                                    @if($kriterias->count() > 0)
                                    <a href="{{ route('admin.subkriteria.dhuafa.create') }}" class="btn-add">
                                    ...
                                    @else
                                    <a href="{{ route('admin.kriteria.dhuafa') }}" class="btn-add">
                                        <i class="fas fa-arrow-left me-1"></i>
                                        Buat Kriteria Dhuafa Terlebih Dahulu
                                    </a>
                                    @endif
                                </div>
                            </td>
