...
<div class="kriteria-container">
    ...
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                ...
                <p class="page-subtitle">Ubah informasi sub kriteria yang sudah ada</p>
            </div>
            <a href="{{ route(
                $kategori === 'dhuafa'
    ...
    <div class="form-container">
        ...
        <form action="{{ route('admin.subkriteria.update', $subkriteria->id) }}" method="POST" class="form-content">
            @csrf
            @method('PUT')
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-help">
                            <i class="fas fa-info-circle"></i>
                            Nilai numerik untuk sub kriteria
                        </div>
                    </div>
                    ...
                    <!-- <div class="form-group">
                        ...
                        <textarea name="deskripsi" 
                                  ...
                                  rows="3"
                                  placeholder="Deskripsi singkat tentang sub kriteria ini...">{{ old('deskripsi', $subkriteria->deskripsi) }}</textarea>
                        @error('deskripsi')
                            <div class="error-message">
                                <i class="fas fa-exclamation-circle"></i>
                                {{ $message }}
                ...
                <div class="current-data-card">
                    ...
                    <div class="current-data-content">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="data-item">
                                    <div class="data-label">Kriteria Induk</div>
                                    <div class="data-value">
                                        <span class="badge badge-primary">{{ $subkriteria->kriteria->kode_kriteria }}</span>
                            ...
                            <div class="col-md-3">
                                <div class="data-item">
                                    <div class="data-label">Nama Sub Kriteria</div>
                                    <div class="data-value">{{ $subkriteria->nama_subkriteria }}</div>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="data-item">
                                    ...
                                    <div class="data-value">
                                        <span class="badge badge-info">{{ $subkriteria->nilai }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="data-item">
                                    ...
                                    <div class="data-value">
                                        {{ $subkriteria->deskripsi ?: 'Tidak ada deskripsi' }}
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="tip-item">
                                    ...
                                    <div class="tip-content">
                                        ...
                                        <p>Perubahan pada sub kriteria akan mempengaruhi perhitungan penilaian yang sudah ada.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="tip-item">
                                    ...
                                    <div class="tip-content">
                                        ...
                                        <p>Data lama akan tersimpan dan perubahan akan tercatat dalam log sistem.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="tip-item">
                                    ...
                                    <div class="tip-content">
                                        ...
                                        <p>Pastikan data yang diubah masih konsisten dengan sistem penilaian.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="selected-criteria-info" id="selectedCriteriaInfo">
                <div class="criteria-card">
                    ...
                    <div class="criteria-details" id="criteriaDetails">
                        @php
                            $currentKriteria = $subkriteria->kriteria;
                            $jenisIcon = $currentKriteria->jenis === 'benefit' ? 'fa-arrow-up text-success' : 'fa-arrow-down text-danger';
                            $jenisText = $currentKriteria->jenis === 'benefit' ? 'Benefit (Semakin Tinggi Semakin Baik)' : 'Cost (Semakin Rendah Semakin Baik)';
                        @endphp
                        <div class="row">
                            <div class="col-md-3">
                                <strong>Kode:</strong><br>
                                <span class="badge badge-primary">{{ $currentKriteria->kode_kriteria }}</span>
                            </div>
                            <div class="col-md-4">
                                <strong>Nama:</strong><br>
                                {{ $currentKriteria->nama_kriteria }}
                            </div>
                            <div class="col-md-2">
                                <strong>Bobot:</strong><br>
                                {{ number_format($currentKriteria->bobot * 100, 2) }}%
                            </div>
                            <div class="col-md-3">
            ...
            <!-- Change Summary -->
            <div class="change-summary" style="display: none;" id="changeSummary">
                <div class="summary-header">
                    <h5><i class="fas fa-clipboard-list"></i> Ringkasan Perubahan</h5>
                </div>
                <div class="summary-content" id="summaryContent">
                    <!-- Summary akan muncul di sini via JavaScript -->
                </div>
            </div>
        </form>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function trackChanges() {
        const currentData = {
            ...
            nama_subkriteria: document.getElementById('nama_subkriteria').value,
        ...
        // Check for changes
        if (currentData.kriteria_id !== originalData.kriteria_id) {
            const oldKriteria = kriteriaData[originalData.kriteria_id];
            const newKriteria = kriteriaData[currentData.kriteria_id];
            changes.push({
                field: 'Kriteria Induk',
                old: oldKriteria ? `${oldKriteria.kode} - ${oldKriteria.nama}` : 'Tidak diketahui',
                new: newKriteria ? `${newKriteria.kode} - ${newKriteria.nama}` : 'Tidak diketahui'
            });
        }
        
        if (currentData.nama_subkriteria !== originalData.nama_subkriteria) {
            changes.push({
                field: 'Nama Sub Kriteria',
                old: originalData.nama_subkriteria,
                new: currentData.nama_subkriteria
            });
        }
        
        if (parseFloat(currentData.nilai) !== parseFloat(originalData.nilai)) {
            changes.push({
                field: 'Nilai',
                old: originalData.nilai,
                new: currentData.nilai
            });
        }
        ...
        if (currentData.deskripsi !== originalData.deskripsi) {
            changes.push({
                field: 'Deskripsi',
                old: originalData.deskripsi || 'Tidak ada',
                new: currentData.deskripsi || 'Tidak ada'
            });
        }
        
        if (changes.length > 0) {
            let summaryHtml = '<div class="changes-list">';
            changes.forEach(change => {
                summaryHtml += `
                    <div class="change-item">
                        <div class="change-field"><strong>${change.field}:</strong></div>
                        <div class="change-values">
                            <span class="old-value">Dari: ${change.old}</span>
                            <i class="fas fa-arrow-right mx-2"></i>
                            <span class="new-value">Ke: ${change.new}</span>
                        </div>
                    </div>
                `;
            });
