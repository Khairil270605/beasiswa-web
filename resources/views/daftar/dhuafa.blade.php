       ...
       readonly>
                ...
                <div class="form-section" data-step="4">
                    ...
                    <div class="upload-area" data-file-type="ktm">
                        ...
                        <p class="mb-3 text-muted">File format: JPG, PNG (Maksimal: 2MB)</p>
                    ...
                    <div class="upload-area" data-file-type="sktm">
                        ...
                        <p class="mb-3 text-muted">File format: PDF (Maksimal: 3MB)</p>
                        <input type="file" id="sktm" name="surat_tidak_mampu" class="file-input" accept=".pdf" required>
                        <button type="button" class="upload-btn" onclick="document.getElementById('sktm').click()">
                            <i class="fas fa-cloud-upload-alt me-2"></i>Pilih File SKTM
                        </button>
                        <div id="sktm-preview"></div>
                    </div>

                    <!-- Surat Tidak Menerima Beasiswa -->
                    <div class="upload-area" data-file-type="tidak_beasiswa">
                        ...
                        <p class="mb-3 text-muted">File format: PDF, JPG, PNG (Maksimal: 2MB)</p>
                        <input type="file" id="tidak_beasiswa" name="surat_tidak_menerima_beasiswa" class="file-input" accept=".pdf,.jpg,.jpeg,.png" required>
                        <button type="button" class="upload-btn" onclick="document.getElementById('tidak_beasiswa').click()">
                            <i class="fas fa-cloud-upload-alt me-2"></i>Pilih File Surat
                        </button>
                        <div id="tidak_beasiswa-preview"></div>
                    </div>
                </div>
                ...
                <div class="form-section" data-step="5">
                    ...
                    <div class="form-info">
                        ...
                        <strong>Info:</strong> Foto kondisi rumah membantu kami memahami kondisi ekonomi keluarga Anda dengan lebih baik.
                    </div>

                    <h5 class="upload-section-title"><i class="fas fa-home me-2"></i>Foto Kondisi Rumah</h5>

                    <!-- Foto Rumah Depan -->
                    <div class="upload-area" data-file-type="foto_depan">
                        ...
                        <p class="mb-3 text-muted">File format: JPG, PNG (Maksimal: 2MB)</p>
                        <input type="file" id="foto_depan" name="foto_rumah_depan" class="file-input" accept=".jpg,.jpeg,.png" required>
                        <button type="button" class="upload-btn" onclick="document.getElementById('foto_depan').click()">
                            <i class="fas fa-cloud-upload-alt me-2"></i>Pilih Foto
                        </button>
                        <div id="foto_depan-preview"></div>
                    </div>

                    <!-- Foto Rumah Samping -->
                    <div class="upload-area" data-file-type="foto_samping">
                        <i class="fas fa-home fa-3x mb-3" style="color: var(--primary-color);"></i>
                        <h5>Upload Foto Rumah Tampak Samping <span class="required-star">*</span></h5>
                        <p class="mb-3 text-muted">File format: JPG, PNG (Maksimal: 2MB)</p>
                        <input type="file" id="foto_samping" name="foto_rumah_samping" class="file-input" accept=".jpg,.jpeg,.png" required>
                        <button type="button" class="upload-btn" onclick="document.getElementById('foto_samping').click()">
                            <i class="fas fa-cloud-upload-alt me-2"></i>Pilih Foto
                        </button>
                        <div id="foto_samping-preview"></div>
                    </div>

                    <!-- Foto Ruang Tamu -->
                    <div class="upload-area" data-file-type="foto_tamu">
                        ...
                        <p class="mb-3 text-muted">File format: JPG, PNG (Maksimal: 2MB)</p>
                        <input type="file" id="foto_tamu" name="foto_ruang_tamu" class="file-input" accept=".jpg,.jpeg,.png" required>
                        <button type="button" class="upload-btn" onclick="document.getElementById('foto_tamu').click()">
                            <i class="fas fa-cloud-upload-alt me-2"></i>Pilih Foto
                        </button>
                        <div id="foto_tamu-preview"></div>
                    </div>

                    <!-- Foto Kamar Mandi -->
                    <div class="upload-area" data-file-type="foto_mandi">
                        ...
                        <p class="mb-3 text-muted">File format: JPG, PNG (Maksimal: 2MB)</p>
                        <input type="file" id="foto_mandi" name="foto_kamar_mandi" class="file-input" accept=".jpg,.jpeg,.png" required>
                        <button type="button" class="upload-btn" onclick="document.getElementById('foto_mandi').click()">
                            <i class="fas fa-cloud-upload-alt me-2"></i>Pilih Foto
                        </button>
                        <div id="foto_mandi-preview"></div>
                    </div>
...
<h5 class="upload-section-title"><i class="fas fa-file-alt me-2"></i>Dokumen Pendukung Lainnya</h5>
                    ...
                    <div class="upload-area" data-file-type="cv">
                        ...
                        <p class="mb-3 text-muted">File format: PDF, DOC, DOCX (Maksimal: 2MB)</p>
                    ...
                    <!-- Motivation Letter -->
                    <div class="upload-area" data-file-type="motivation">
                        ...
                        <p class="mb-3 text-muted">File format: PDF, DOC, DOCX (Maksimal: 2MB)</p>
                        <input type="file" id="motivation" name="motivation_letter" class="file-input" accept=".pdf,.doc,.docx" required>
                        <button type="button" class="upload-btn" onclick="document.getElementById('motivation').click()">
                            <i class="fas fa-cloud-upload-alt me-2"></i>Pilih File Motivation Letter
                        </button>
                        <div id="motivation-preview"></div>
                    </div>
                    ...
                    <div class="upload-area" data-file-type="relawan">
                        ...
                        <p class="mb-3 text-muted">File format: PDF, JPG, PNG (Maksimal: 2MB)</p>
                        <input type="file" id="relawan" name="surat_kesanggupan_relawan" class="file-input" accept=".pdf,.jpg,.jpeg,.png" required>
                        <button type="button" class="upload-btn" onclick="document.getElementById('relawan').click()">
                            <i class="fas fa-cloud-upload-alt me-2"></i>Pilih File Surat
                        </button>
                        <div id="relawan-preview"></div>
                    </div>
                </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const nameInputs = ['nama', 'nama_ayah', 'nama_ibu', 'tempat_lahir'];
