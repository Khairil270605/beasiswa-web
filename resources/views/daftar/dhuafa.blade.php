...
<div class="container">
    <div class="main-container">
        ...
        <div class="header-section">
            ...
            <h5 class="mb-3 opacity-90">Kategori: Beasiswa Dhuafa</h5>
        ...
        <form id="dhuafaForm" action="/daftar/dhuafa" method="POST" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="jenis_pendaftaran" value="dhuafa">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            ...
                            <label for="nik">NIK (16 digit) <span class="required-star">*</span></label>
                        </div>
                    </div>
                </div>
            ...
            <div class="form-section" data-step="2">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-floating">
                            ...
                            <label for="nim">NIM <span class="required-star">*</span></label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-floating">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-floating">
                            ...
                            <label for="ipk">IPK (0 – 4) <span class="required-star">*</span></label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-floating">
                ...
                <div class="form-floating">
                    <textarea class="form-control" id="prestasi" name="prestasi" style="height:120px" placeholder="Prestasi"></textarea>
            ...
            <div class="form-section" data-step="3">
                ...
                <div class="form-info">
                    <i class="fas fa-info-circle me-2 text-info"></i>
                    <strong>Penting:</strong> Data ekonomi keluarga digunakan untuk menilai kebutuhan beasiswa.
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            <input type="number" class="form-control" id="penghasilan_ibu" name="penghasilan_ibu" placeholder="Penghasilan Ibu" min="0" required>
                            <label for="penghasilan_ibu">Penghasilan Ibu (Rp/bulan) <span class="required-star">*</span></label>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-floating">
                    <textarea class="form-control" id="kondisi_ekonomi" name="kondisi_ekonomi" style="height:120px" placeholder="Kondisi Ekonomi" required></textarea>
                    <label for="kondisi_ekonomi">Deskripsi Kondisi Ekonomi Keluarga <span class="required-star">*</span></label>
                </div>
            </div>

            <!-- ===================== STEP 4: Upload Dokumen Utama ===================== -->
            <div class="form-section" data-step="4">
                <h3 class="section-title">
                    <div class="section-icon"><i class="fas fa-upload"></i></div>
                    Upload Dokumen Utama <span class="required-star">*</span>
                </h3>
                ...
                <div class="upload-grid">
                    ...
                    <label class="upload-card" id="card-sktm" for="sktm">
                        <i class="fas fa-file-medical card-icon"></i>
                        <p class="card-label">SKTM <span class="required-star">*</span></p>
                        <p class="card-hint">PDF · maks 3MB</p>
                        <span class="card-filename" id="name-sktm"></span>
                        <button type="button" class="remove-btn" id="rm-sktm" onclick="removeFileCard(event,'sktm')" style="display:none">✕</button>
                        <input type="file" id="sktm" name="surat_tidak_mampu" accept=".pdf" required>
                    </label>
            ...
            <!-- ===================== STEP 5: Upload Dokumen Tambahan ===================== -->
            <div class="form-section" data-step="5">
                <h3 class="section-title">
                    <div class="section-icon"><i class="fas fa-images"></i></div>
                    Upload Dokumen Tambahan <span class="required-star">*</span>
                </h3>

                <div class="form-info">
                    <i class="fas fa-camera me-2 text-info"></i>
                    <strong>Info:</strong> Klik kartu untuk memilih file. Foto rumah membantu penilaian kondisi ekonomi keluarga.
                </div>

                <!-- Foto Rumah -->
                <p class="upload-group-label"><i class="fas fa-home me-1"></i> Foto Kondisi Rumah</p>
                <div class="upload-grid">

                    <label class="upload-card" id="card-foto_depan" for="foto_depan">
                        <i class="fas fa-home card-icon"></i>
                        <p class="card-label">Tampak Depan <span class="required-star">*</span></p>
                        <p class="card-hint">JPG/PNG · maks 2MB</p>
                        <span class="card-filename" id="name-foto_depan"></span>
                        <button type="button" class="remove-btn" id="rm-foto_depan" onclick="removeFileCard(event,'foto_depan')" style="display:none">✕</button>
                        <input type="file" id="foto_depan" name="foto_rumah_depan" accept=".jpg,.jpeg,.png" required>
                    </label>

                    <label class="upload-card" id="card-foto_samping" for="foto_samping">
                        <i class="fas fa-home card-icon"></i>
                        <p class="card-label">Tampak Samping <span class="required-star">*</span></p>
                        <p class="card-hint">JPG/PNG · maks 2MB</p>
                        <span class="card-filename" id="name-foto_samping"></span>
                        <button type="button" class="remove-btn" id="rm-foto_samping" onclick="removeFileCard(event,'foto_samping')" style="display:none">✕</button>
                        <input type="file" id="foto_samping" name="foto_rumah_samping" accept=".jpg,.jpeg,.png" required>
                    </label>

                    <label class="upload-card" id="card-foto_tamu" for="foto_tamu">
                        <i class="fas fa-couch card-icon"></i>
                        <p class="card-label">Ruang Tamu <span class="required-star">*</span></p>
                        <p class="card-hint">JPG/PNG · maks 2MB</p>
                        <span class="card-filename" id="name-foto_tamu"></span>
                        <button type="button" class="remove-btn" id="rm-foto_tamu" onclick="removeFileCard(event,'foto_tamu')" style="display:none">✕</button>
                        <input type="file" id="foto_tamu" name="foto_ruang_tamu" accept=".jpg,.jpeg,.png" required>
                    </label>

                    <label class="upload-card" id="card-foto_mandi" for="foto_mandi">
                        <i class="fas fa-bath card-icon"></i>
                        <p class="card-label">Kamar Mandi <span class="required-star">*</span></p>
                        <p class="card-hint">JPG/PNG · maks 2MB</p>
                        <span class="card-filename" id="name-foto_mandi"></span>
                        <button type="button" class="remove-btn" id="rm-foto_mandi" onclick="removeFileCard(event,'foto_mandi')" style="display:none">✕</button>
                        <input type="file" id="foto_mandi" name="foto_kamar_mandi" accept=".jpg,.jpeg,.png" required>
                    </label>

                    <label class="upload-card" id="card-foto_dapur" for="foto_dapur">
                        <i class="fas fa-utensils card-icon"></i>
                        <p class="card-label">Dapur <span class="required-star">*</span></p>
                        <p class="card-hint">JPG/PNG · maks 2MB</p>
                        <span class="card-filename" id="name-foto_dapur"></span>
                        <button type="button" class="remove-btn" id="rm-foto_dapur" onclick="removeFileCard(event,'foto_dapur')" style="display:none">✕</button>
                ...
                <!-- Dokumen Pendukung -->
                <p class="upload-group-label"><i class="fas fa-file-alt me-1"></i> Dokumen Pendukung</p>
                <div class="upload-grid">
                    ...
                    <label class="upload-card" id="card-motivation" for="motivation">
                        <i class="fas fa-envelope-open-text card-icon"></i>
                        <p class="card-label">Motivation Letter <span class="required-star">*</span></p>
                        <p class="card-hint">PDF/DOC/DOCX · maks 2MB</p>
                        <span class="card-filename" id="name-motivation"></span>
                        <button type="button" class="remove-btn" id="rm-motivation" onclick="removeFileCard(event,'motivation')" style="display:none">✕</button>
                        <input type="file" id="motivation" name="motivation_letter" accept=".pdf,.doc,.docx" required>
                    </label>
                    ...
                    <label class="upload-card" id="card-relawan" for="relawan">
                        <i class="fas fa-hands-helping card-icon"></i>
                        <p class="card-label">Surat Relawan <span class="required-star">*</span></p>
                        <p class="card-hint">PDF/JPG/PNG · maks 2MB</p>
                        <span class="card-filename" id="name-relawan"></span>
                        <button type="button" class="remove-btn" id="rm-relawan" onclick="removeFileCard(event,'relawan')" style="display:none">✕</button>
                        <input type="file" id="relawan" name="surat_kesanggupan_relawan" accept=".pdf,.jpg,.jpeg,.png" required>
                    </label>
...
/* ---- File size limits ---- */
const fileSizeLimits = { transkrip: 5, penghasilan: 3, sktm: 3 };
...
/* ---- Submit ---- */
document.getElementById('dhuafaForm').addEventListener('submit', function (e) {
    let allValid = true;
    let firstBad = null;
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    ['nama','nama_ayah','nama_ibu','tempat_lahir'].forEach(id => {
        const el = document.getElementById(id);
