...
@section('title', 'Informasi Beasiswa Dhuafa - LAZISMU DIY')
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-8 mx-auto text-center hero-content">
                ...
                <h1 class="display-4 fw-bold mb-3">Beasiswa Dhuafa</h1>
                <h3 class="mb-4">Beasiswa Sang Surya LAZISMU DIY 2024/2025</h3>
                <p class="lead mb-4">
                    Bantuan biaya pendidikan bagi mahasiswa dari keluarga kurang mampu/miskin
                </p>
...
<div class="container my-5">
    ...
    <div class="info-card">
        ...
        <p class="mb-0">
            Beasiswa Dhuafa adalah program bantuan pendidikan yang diperuntukkan bagi mahasiswa dari keluarga kurang mampu/miskin agar tetap dapat melanjutkan pendidikan tinggi tanpa terkendala biaya. Program ini merupakan wujud kepedulian LAZISMU DIY dalam mencerdaskan kehidupan bangsa dan mewujudkan pemerataan akses pendidikan. Melalui program ini, kami berharap dapat melahirkan generasi penerus bangsa yang memiliki kedalaman ilmu pengetahuan dan keluhuran akhlak.
        </p>
    </div>
    ...
    <div class="info-card">
        ...
        <div class="facilities-grid">
            ...
            <div class="facility-card">
                ...
                <p class="small text-muted mb-0">Program pengembangan diri</p>
            </div>
            <div class="facility-card">
                <i class="fas fa-users"></i>
                <h6 class="fw-bold">Networking</h6>
                <p class="small text-muted mb-0">Jaringan sesama penerima beasiswa</p>
            </div>
            <div class="facility-card">
    ...
    <div class="info-card">
        <h3>
            ...
            Persyaratan Khusus Beasiswa Dhuafa
        </h3>
        <div class="requirements-grid">
            <div class="req-item">
                <i class="fas fa-check-circle"></i>
                <strong>Berasal dari keluarga kurang mampu/miskin dengan penghasilan orang tua terbatas</strong>
            </div>
            <div class="req-item">
                <i class="fas fa-check-circle"></i>
                <strong>Memiliki Surat Keterangan Tidak Mampu (SKTM) dari kelurahan/desa setempat</strong>
            </div>
            <div class="req-item">
                <i class="fas fa-check-circle"></i>
                <strong>Melampirkan slip gaji orang tua atau surat keterangan penghasilan</strong>
            </div>
            <div class="req-item">
                <i class="fas fa-check-circle"></i>
                <strong>Melampirkan foto kondisi rumah (depan, samping, ruang tamu, kamar mandi, dapur)</strong>
            </div>
        </div>
    </div>
    ...
    <div class="info-card">
        ...
        <div class="documents-grid">
            ...
            <div class="doc-card">
                ...
                <h6 class="small fw-bold mb-1">SKTM</h6>
                <small class="text-muted">PDF<br>Max: 3MB</small>
            </div>
            <div class="doc-card">
        ...
        <div class="documents-grid">
            ...
            <div class="doc-card">
                ...
                <h6 class="small fw-bold mb-1">Pas Foto 3x4</h6>
                <small class="text-muted">JPG/PNG<br>Max: 2MB</small>
            </div>
            <div class="doc-card">
        ...
        <div class="alert alert-info mt-4 mb-0">
            ...
            <ul class="mb-0 mt-2">
                ...
                <li>Nama file sebaiknya sesuai dengan jenis dokumen (misal: KTP_NamaAnda.pdf)</li>
            </ul>
        </div>
    </div>
    ...
    <div class="info-card">
        ...
        <div class="timeline">
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-content">
                    <h6 class="fw-bold mb-1">Wawancara & Survey Lapangan</h6>
                    <p class="text-muted small mb-1">Wawancara dengan calon penerima</p>
                    <p class="text-muted small mb-0">Survey kondisi ekonomi keluarga (jika diperlukan)</p>
                </div>
            </div>
            <div class="timeline-item">
    ...
    <div class="info-card">
        ...
        <div class="requirements-grid">
            <div class="req-item">
                <i class="fas fa-check-circle"></i>
                <strong>Aktif mengikuti kegiatan pembinaan yang diadakan LAZISMU</strong>
            </div>
            <div class="req-item">
                <i class="fas fa-check-circle"></i>
            ...
            <div class="req-item">
                <i class="fas fa-check-circle"></i>
                <strong>Menjaga nama baik LAZISMU dan almamater</strong>
            </div>
            <div class="req-item">
                <i class="fas fa-check-circle"></i>
                <strong>Membuat laporan perkembangan studi setiap semester</strong>
            </div>
        </div>
    </div>
...
<div class="container mb-5" id="daftar">
    <div class="cta-section">
        ...
        <h2 class="fw-bold mb-3">Siap Mendaftar Beasiswa Dhuafa?</h2>
        <p class="lead mb-4">Pastikan semua dokumen sudah disiapkan sebelum mengisi formulir pendaftaran</p>
        <a href="{{ route('daftar.dhuafa') }}" class="btn btn-daftar">
